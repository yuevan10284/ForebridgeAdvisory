        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            <div className="flex flex-col items-center text-center p-6">
              ...
              <h3 className="font-display text-xl mb-4">Build</h3>
            ...
            <div className="flex flex-col items-center text-center p-6">
              ...
              <h3 className="font-display text-xl mb-4">Launch</h3>
              <p className="text-gray-600">
            ...
            <div className="flex flex-col items-center text-center p-6">
              ...
              <h3 className="font-display text-xl mb-4">Scale</h3>
              <p className="text-gray-600">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="p-6">
              ...
              <h3 className="font-display text-xl mb-3">SF Immersion</h3>
              <p className="text-gray-600">
            ...
            <div className="p-6">
              ...
              <h3 className="font-display text-xl mb-3">Daily Mentorship</h3>
              <p className="text-gray-600">
            ...
            <div className="p-6">
              ...
              <h3 className="font-display text-xl mb-3">Full Coverage</h3>
              <p className="text-gray-600">
            ...
            <div className="p-6">
              ...
              <h3 className="font-display text-xl mb-3">30-Day Sprint</h3>
              <p className="text-gray-600">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6">
            <div className="relative p-6 border border-gray-800">
              ...
              <h3 className="font-display text-xl mb-3">Apply</h3>
            ...
            <div className="relative p-6 border border-gray-800">
              ...
              <h3 className="font-display text-xl mb-3">Sprint</h3>
              <p className="text-gray-400">
            ...
            <div className="relative p-6 border border-gray-800">
              ...
              <h3 className="font-display text-xl mb-3">Scale</h3>
              <p className="text-gray-400">
